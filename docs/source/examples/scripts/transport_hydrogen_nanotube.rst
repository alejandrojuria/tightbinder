Transmission of a nanotube
================================

.. code-block:: python
    :caption: transport_hydrogen_nanotube
...
Executing this scripts (which may take some seconds) yields the following plots:

.. image:: ../plots/transport_nanotube.png
    :align: center
